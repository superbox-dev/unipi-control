...
class UnipiControl:
    ...
    async def _init_tasks(self) -> None:
        async with AsyncExitStack() as stack:
            ...
            tasks = await plugin.init_task(stack)
...
def install() -> None:
    ...
    if enable_and_start_systemd.lower() == "y":
        print(
            colored("-> Enable systemd service \"unipi-control.service\"",
                    "green"))
        ...
        print(
            colored("systemctl enable --now unipi-control",
                    "magenta",
                    attrs=[
                        "bold",
                    ]))
